...
export function Home () {
    return(
        <section className="relative h-screen z-10 px-4">
            <div className="max-w-260 h-full mx-auto flex items-center justify-center flex-col gap-3 md:gap-7">
                <div className="flex flex-col gap-0 text-(length:--big-fz) text-white font-[Raleway] text-center font-bold leading-none">
